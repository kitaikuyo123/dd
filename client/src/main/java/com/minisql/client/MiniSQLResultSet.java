 ...
 * 负责模块: 开发者C
 */
public class MiniSQLResultSet implements ResultSet {
    ...
    public int findColumn(String columnLabel) throws SQLException {
        ...
        for (int i = 0; i < columnNames.size(); i++) {
            if (columnNames.get(i).equalsIgnoreCase(columnLabel)) {
                return i + 1; // JDBC column indices are 1-based
            }
        }
    ...
    public String getString(int columnIndex) throws SQLException {
        ...
        return getString(columnNames.get(columnIndex - 1));
    }
    ...
    public String getString(String columnLabel) throws SQLException {
        ...
        Object value = row.getValue(columnLabel);
    ...
    public Object getObject(int columnIndex) throws SQLException {
        return getObject(columnNames.get(columnIndex - 1));
    }

    @Override
    public int getInt(int columnIndex) throws SQLException {
        return getInt(columnNames.get(columnIndex - 1));
    }
    ...
    public long getLong(int columnIndex) throws SQLException {
        return getLong(columnNames.get(columnIndex - 1));
    }
    ...
    public double getDouble(int columnIndex) throws SQLException {
        return getDouble(columnNames.get(columnIndex - 1));
    }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        checkClosed();
        return new MiniSQLResultSetMetaData(columnNames, columnTypes, tableName);
    }
    ...
    @Override
    public boolean isBeforeFirst() throws SQLException { return currentRow < 0; }
    @Override
    public boolean isAfterLast() throws SQLException { return currentRow >= rows.size(); }
    @Override
    public boolean isFirst() throws SQLException { return currentRow == 0; }
    @Override
    public boolean isLast() throws SQLException { return currentRow == rows.size() - 1; }
    @Override
    public void beforeFirst() throws SQLException { currentRow = -1; }
    @Override
    public void afterLast() throws SQLException { currentRow = rows.size(); }
    @Override
    ...
    @Override
    public int getRow() throws SQLException { return currentRow + 1; }
    @Override
